...
def seller_summary(seller_id):
    ...
    if not overall:
        overall = {"avg_rating": 0, "total_reviews": 0}
    ...
    return jsonify({
        ...
        "categories": {
            c["category"]: float(c["avg_star"]) for c in categories
        }
    })
...
# ─────────────────────────────────────────────
# GET /api/sellers
# Saare sellers list with review count
# ─────────────────────────────────────────────
...
# Rejected reviews — DB mein dikhne ke liye
# ─────────────────────────────────────────────
...
# Seller intent + dynamic categories
# OpenAI → Gemini → NLP fallback
# ─────────────────────────────────────────────
...
def seller_deep_analysis(seller_id):
    ...
    from seller_analysis import analyze_seller
